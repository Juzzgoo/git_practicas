...
console.writeln(`La resta de la fracción ${numerador1}/${denominador1} y la fracción ${numerador2}/${denominador2} es la fracción ${numerador1 * denominador2 - numerador2 * denominador1}/${denominador1 * denominador2}`);