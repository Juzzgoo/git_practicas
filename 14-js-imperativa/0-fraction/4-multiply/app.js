...
console.writeln(`El producto de la fracción ${numerador1}/${denominador1} y la fracción ${numerador2}/${denominador2} es la fracción ${numerador1 * numerador2}/${denominador1 * denominador2}`);